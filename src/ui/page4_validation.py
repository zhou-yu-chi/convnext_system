...
class Page4_Verification(QWidget):
    ...
    def __init__(self, data_handler):
        ...
        self.reports_root = ""
        self.init_ui()
    def set_dataset_root(self, path):
        self.dataset_root = path

    def set_models_root(self, path):
        self.models_root = path
    def set_reports_root(self, path):
        """ 新增：讓 MainWindow 呼叫並傳入報告路徑"""
    ...
    def on_load_images(self):
        ...
        start_dir = self.dataset_root if self.dataset_root else ""
    ...
    def save_report(self, results, summary):
        ...
        try:
            report_dir = self.reports_root if self.reports_root else "validation_reports"
