...
from ui.page0_camera import Page_Camera # 新增這行
...
from ui.page7_realtime import Page7_RealtimeInference
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.dataset_root = str(control.path_manager.DATASET_ROOT)
        ...
        self.page_camera = Page_Camera(self.data_handler)
        ...
        self.page3.set_data_handler(self.data_handler)
        self.page3.set_models_root(str(control.path_manager.MODELS_ROOT))

        self.page3.set_data_handler(self.data_handler) # <--- 加入這行！
        self.page4 = Page4_Verification(self.data_handler)
        self.page4.set_dataset_root(str(control.path_manager.DATASET_ROOT))
        self.page4.set_models_root(str(control.path_manager.MODELS_ROOT))
        self.page4.set_reports_root(str(control.path_manager.REPORTS_ROOT))
        self.page6 = Page6_ResultReview()
        self.page_realtime = Page7_RealtimeInference()
        self.page_realtime.set_models_root(str(control.path_manager.MODELS_ROOT))
        self.tabs.addTab(self.page_camera, "1. 拍照擷取")
        self.tabs.addTab(self.page0, "2. 圖片裁切")
        self.tabs.addTab(self.page1, "3. 照片標註")
        self.tabs.addTab(self.page2, "4. 結果檢查")
        self.tabs.addTab(self.page3, "5. 模型訓練")
        self.tabs.addTab(self.page4, "6. 驗證檢測")
        self.tabs.addTab(self.page6, "7. 錯誤分析")
        self.tabs.addTab(self.page_realtime, "8.即時推論")
    ...
    def close_project(self):
        ...
        if reply == QMessageBox.StandardButton.Yes:
            ...
            if hasattr(self, 'page_camera'):
                self.page_camera.stop_camera()

            if hasattr(self, 'page_realtime'):
                self.page_realtime.stop_inference()
    ...
    def apply_stylesheet(self):
        ...
        /* ---------------------------------------------------- */
        /* ★ 新增：強制修正彈窗 (QMessageBox, QInputDialog) 的樣式 */
        /* ---------------------------------------------------- */
